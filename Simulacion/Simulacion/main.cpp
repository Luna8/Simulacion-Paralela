...
//OBSERVACIÓN: A pesar del tiempo extra brindado, por diferentes motivos no logramos concluir a tiempo
...
int main()
{
	...
	Simulador simulador;
	//Lectura de archivos
	//Se modificaron los parámetros de las funciones para la lectura de datos.
